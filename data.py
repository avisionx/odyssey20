...
fun = [{
        ...
        'name': "HuntIt",
        'date': "17th January",
        'time': "1100 hrs (or should it be 10:00?)",
        'venue': "OAT",
        'prize': "15K cash",
        'team': "1-4",
        ...
        'prize': "TBA",
        'team': "TBA",
        'description': "Food Arena, for all the foodies around the world, unleash your hunger, with the most exciting food from around the world. <br> Stuff yourself with something unexpected, something that seems to be heaven but turns out to be HELL. <br> Eat the food like never before. <br> Got some serious appetite like ADAM RICHMAN? Daring enough to swallow everything we present? <br> So come challenge your biggest nightmare!!! <br>EVENT DETAIL: <br> It will be having the following sub-events: <br>  Food Quizzes: It will be an online event and this will include food themed quizzes like General Knowledge , Series and Movies based etc. And the quizzes will be conducted on the insta handle starting 3 days before the fest. <br> Mystery Taste Test: It will be an onsite event and Players try to guess what food they are eating while blindfolded.Players taste each food at the same time and the first one to call out the correct answer to what they are eating wins a point. 10 Rounds , and the one with maximum points win. In this game you have to name the ingredients from the dish you are eating. <br> Name the Dish: It will be an onsite event and The Participants will have to guess the whole dish by tasting its few ingredients. <br> . Food photography : Online / Offline event: Click Pictures of Food and Send us. It will include the presentation of food and editing skills too. <br> Caption the picture: Online event and You will have to provide a catchy and quirky caption to the food pictures. <br> Drink and Reverse the Cup: It will be an onsite team event in which each member has to drink a whole glass of pepsi/soft drink one after another and the team to finish it first wins. <br> Bite the Fruit: It will be an onsite event and the players have to try and bite the apple/banana hanging from a ceiling via string with their mouth without using their hands. <br> Toss Challenge Game : Players in teams of 2 try to catch the most candies in their cup.Have the players on the teams stand five feet apart. Players then throw their candies to their teammate while the teammate tries to catch them in their paper cup in one minute. The player then have to reverse the roles and do the same again. The one with the maximum candis in their cup wins. <br> Eat without your Hands: It will be an onsite event and the participant will have to eat a bowl full of some dish without using his hands . the one who finishes off the dish first will win. <br> Like whipped cream faces - Players kneel before their plates and on the count of three attempt to eat all their M&Ms (placed in whipped cream) first. The player who does so is the winner. Spaghetti Challenge - Players must eat the spaghetti without silverware and with their hands behind their backs. <br> . Chopstick Challenges: It will be an onsite event . We will choose a food that is difficult to eat with chopsticks, such as cooked spaghetti, pudding, or slippery fruit, such as peach slices. The goal is to see who can eat their small bowl of food the quickest. <br> Food-Themed “Musical” Chair: It will be an onsite event .The participants will have to play musical chair with a twist. After the music starts playing , the one that completes their share of food first will go and sit on chair. One participant will be eliminated after each round. <br> Pea Pipes - The participants will have to suck peas through straws and put them in another bowl. The one having maximum Peas in the bowl at the end will win.",
        'rules':[
            "-Only one person per registration will be entertained.",
            "--Person allergic to certain food item should not participate/ inform beforehand",
